...
export default function Product({ isHome = false }) {
const [category, setCategory] = useState("All");
const [material, setMaterial] = useState("All");
const [priceRange, setPriceRange] = useState("All");
const [search, setSearch] = useState("");
...
const productContent = ( <section className="product-section" id="products">
  ...
  <div className="product-heading">
    ...
    <div>
      ...
      <p>
        Explore our premium Indonesian craft products,
        carefully selected and manufactured for global markets.
      </p>
    </div>
